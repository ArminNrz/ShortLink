...
import com.neshan.shortLink.security.data.AuthorizationData;
    ...
    private void authorizeRequest(String authorizationHeader, HttpServletResponse response) throws IOException {
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            ...
            try {
                ...
                AuthorizationData authorizationData = this.extractAuthorizationData(token);
                ...
                securityUtil.handleUnAuthorizeException(exception, response);
            }
        }
    }
